...
<div id="sidebar"
	...
	<ul class="nav nav-list">
		<li><a href="#" class="dropdown-toggle"> <i
				...
				Quản lý thực tập sinh <b class="arrow fa fa-angle-down"></b>
		</a> <b class="arrow"></b>
			<ul class="submenu">
				<li><a
					href='<c:url value="/admin-trainee-list"/>'>
						<i class="menu-icon fa fa-caret-right"></i> Danh sách thực tập sinh
				</a> <b class="arrow"></b></li>
				<li><a
					href='<c:url value="/admin-pending-list"/>'>
						<i class="menu-icon fa fa-caret-right"></i> Danh sách chờ duyệt
				</a> <b class="arrow"></b></li>
			</ul></li>
	</ul>
